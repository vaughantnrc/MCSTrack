...
class _Configuration(PoseSolver.Configuration):
...
class StandardPoseSolver(PoseSolver):
    """
    Class implementing a "recommended" method for solving poses.
    """
    Configuration: type[PoseSolver.Configuration] = _Configuration
    ...
    def __init__(
        ...
        if isinstance(configuration, dict):
            configuration = StandardPoseSolver.Configuration(**configuration)
        super().__init__(
